...
class ApplicationCasesSpider(scrapy.Spider):
    name = 'application_cases'
    allowed_domains = ['aii-alliance.org']

    start_urls = ['http://www.aii-alliance.org/index.php?m=content&c=index&a=lists&catid=40&page=1']
